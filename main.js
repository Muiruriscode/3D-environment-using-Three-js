...
// const dlLightShadowHelper = new THREE.CameraHelper(directionalLight.shadow.camera)
...
window.addEventListener('mousemove', function(e){
    ...
    mousePosition.Y = (e.clientX / this.window.innerWidth) * 2 + 1
})
...
function animate(time){
    ...
    for(let i=0; i < intersects.length; i++){
        ...
        // if(intersects[i].object.name === 'thePlane'){
